...
<rect x="40" y="154" width="340" height="42" rx="7" fill="#E06A3C"/>
<rect x="40" y="202" width="340" height="42" rx="7" fill="#2a3542"/>
<text x="56" y="36" fill="#F0E9DB" font-family="sans-serif" font-size="13" font-weight="700">Nagłówek — numer, daty, nr KSeF</text>
<text x="56" y="84" fill="#F0E9DB" font-family="sans-serif" font-size="13" font-weight="700">Sprzedawca — Podmiot1 (dostawca)</text>
<text x="56" y="132" fill="#F0E9DB" font-family="sans-serif" font-size="13" font-weight="700">Nabywca — Podmiot2 (Ty)</text>
...
<text x="56" y="228" fill="#F0E9DB" font-family="sans-serif" font-size="13" font-weight="700">Podsumowanie i płatność</text>
</svg>
