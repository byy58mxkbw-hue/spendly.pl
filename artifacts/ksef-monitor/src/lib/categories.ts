...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    emoji: "❄️",
    keywords: [
      "mrożon", "mrozon", "frozen", "deep frozen",
      "lody ", "lodu ", "lodów", "lód ", "ice cream", "sorbet", "gelato",
      "frytki", "frytek", "frytka", "tater tots", "wedge", "potato fries",
      "pizza mrożona", "pizza zamrożona",
      "warzywa mrożone", "owoce mrożone", "groszek mrożony",
      "szpinak mrożony", "szparagi mrożone", "edamame",
      "filet mrożony", "ryba mrożona", "krewetki mrożone",
      "mięso mrożone", "burgery mrożone", "kotlet mrożony",
      "pierogi mrożone", "krokiety mrożone", "kopytka mrożone",
      "nuggets", "nuggety", "strips mrożone",
      "lody kulki", "lody gałki", "wafelek lodowy",
    ],
  },
  {
    id: "przyprawy",
